...
"""newrelic_apm_key_transaction module."""
...
DOCUMENTATION = r"""
---
module: newrelic_apm_key_transaction
short_description: Manage New Relic key transactions
description:
    - Manage New Relic key transactions.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.newrelic.newrelic_apm_key_transaction:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("transaction_id",))],
    )
