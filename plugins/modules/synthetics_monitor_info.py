...
DOCUMENTATION = r"""
---
module: synthetics_monitor_info
short_description: Retrieve information about synthetics_monitor resources
version_added: "1.0.0"
description:
  - Retrieve a single synthetics_monitor by its identifier, or list all synthetics_monitor resources.
...
options:
  guid:
    description:
      - The unique identifier of the synthetics_monitor to retrieve.
      - When omitted, all synthetics_monitor resources are listed.
    type: str
    required: false
...
EXAMPLES = r"""
- name: Get a specific synthetics_monitor
  stevefulme1.newrelic.synthetics_monitor_info:
    guid: "example_id"
  register: result

- name: List all synthetics_monitor resources
  stevefulme1.newrelic.synthetics_monitor_info:
  register: result
...
RETURN = r"""
synthetics_monitors:
  description: List of synthetics_monitor resources matching the query.
  returned: always
  type: list
  elements: dict
  contains:
...
def main():
    ...
    try:
        ...
        if identifier is not None:
            ...
            result["synthetics_monitors"] = [item] if item else []
        else:
            result["synthetics_monitors"] = fetch_list(client, module)
